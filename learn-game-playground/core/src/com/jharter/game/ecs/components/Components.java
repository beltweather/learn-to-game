...
public final class Components {
	...
	public static final class CursorComp implements C, Unique {
		...
		//public Array<ID> turnActionTargetIDs = new Array<ID>(); // The history of targets based on cursor "select" events, somewhat redundant with turn action list
	...
	public static final class TurnActionSelectedEvent implements C {

		public long timestamp = Long.MAX_VALUE;

		private TurnActionSelectedEvent() {}
	...
	public static final class TurnActionQueueItemComp implements C {

		public long timestamp = Long.MAX_VALUE;

		private TurnActionQueueItemComp() {}
