...
import com.jharter.game.tween.tweenstudio.src.TweenStudio;
...
public class App implements ApplicationListener {
	...
	public void create() {
		...
		//    performance reason.
		TweenStudio.preloadAnimation(Gdx.files.absolute("X:/GitHub/learn-to-game/learn-game-playground/core/assets/data/anim1.timeline").file(), ANIMATION_1);
		TweenStudio.preloadAnimation(Gdx.files.absolute("X:/GitHub/learn-to-game/learn-game-playground/core/assets/data/anim2.timeline").file(), ANIMATION_2);
