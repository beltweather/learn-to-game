...
public class EnemyHelper extends EntityHandler {
	...
	public ID addAtma(ZoneComp enemyZone, ZoneComp infoZone) {
		...
		b.VitalsComp().vitals.maxHealth.d(500); //10000;
		b.VitalsComp().vitals.health.d(500); //10000;
		b.StatusEffectsComp().effects.maxEffects = 5;
		b.StatusEffectsComp().effects.weakToTypes.d().add(StatusEffectType.FIRE);
		b.StatusEffectsComp().effects.resistantToTypes.d().add(StatusEffectType.ICE);
		b.StatusEffectsComp().effects.immuneToTypes.d().add(StatusEffectType.LIGHTNING);
		b.StatusEffectsComp().effects.setToDefault();
	...
	public ID addCactar(ZoneComp enemyZone, ZoneComp infoZone) {
		...
		b.EnemyComp();
		b.AssociatedTurnActionsComp();
		b.VitalsComp().vitals.maxHealth.d(500);
		b.VitalsComp().vitals.health.d(500);
		b.StatusEffectsComp().effects.maxEffects = 4;
		b.StatusEffectsComp().effects.weakToTypes.d().add(StatusEffectType.POISON);
		b.StatusEffectsComp().effects.resistantToTypes.d().add(StatusEffectType.LIGHTNING);
		b.StatusEffectsComp().effects.setToDefault();
